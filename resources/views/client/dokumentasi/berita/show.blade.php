        ...
        <div class="max-w-2xl mx-auto px-4 py-8">
            ...
            <div class="flex items-center text-gray-600 text-sm mb-4">
                <svg class="w-4 h-4 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                        d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm-1-11h2v6h-2zm0 4h2v2h-2z" />
                </svg>
                <span>{{ $publication->created_at->format('F d, Y') }}</span>
            </div>

            <div class="prose max-w-full mb-8">
                <?php echo html_entity_decode($publication->publication_desc); ?>
            </div>
