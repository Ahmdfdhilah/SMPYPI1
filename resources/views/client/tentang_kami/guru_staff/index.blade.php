                ...
                <div class="mb-6 lg:mb-0">
                    <div
                        ...
                        <div class="relative overflow-hidden bg-cover bg-no-repeat">
                            <img src="/image/{{$employee->employee_img}}" class="w-full lg:max-h-[30rem] object-cover rounded-t-lg" />
                            <a href="#!">
                                <div class="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed">
                                </div>
                            </a>
                            <svg class="absolute text-white  left-0 bottom-0"
                        ...
                        <div class="p-6">
                            ...
                            <p class="mb-4 text-neutral-500">{{ $employee->employee_position }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
