...
<head>
    ...
    <title>SMP YPI 1 BRAJA SELEBAH | 404 ERROR</title>
</head>
<body>
    ...
    <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div class="flex flex-col items-center max-w-sm mx-auto text-center">
            ...
            <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                <a href="{{ $previousUrl }}"class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
